...
Q_CONSTINIT static const uint qt_meta_data_ZN13ReleverMesureE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       1,    9,   56,    2, 0x06,    1 /* Public */,
      12,    0,   75,    2, 0x06,   11 /* Public */,
      13,    0,   76,    2, 0x06,   12 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      14,    0,   77,    2, 0x0a,   13 /* Public */,
      15,    0,   78,    2, 0x0a,   14 /* Public */,

 // methods: name, argc, parameters, tag, flags, initial metatype offsets
      16,    0,   79,    2, 0x02,   15 /* Public */,
      17,    0,   80,    2, 0x02,   16 /* Public */,
...
void ReleverMesure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->requestStop(); break;
        case 3: _t->actualisationMesuresSPECS(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ReleverMesure::*)();
            if (_q_method_type _q_method = &ReleverMesure::requestRestart; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (ReleverMesure::*)();
            if (_q_method_type _q_method = &ReleverMesure::requestStop; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void ReleverMesure::requestRestart()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void ReleverMesure::requestStop()
{
