...
namespace {
struct qt_meta_tag_ZN16FenetreConnexionE_t {};
} // unnamed namespace
...
Q_CONSTINIT static const uint qt_meta_data_ZN16FenetreConnexionE[] = {
...
Q_CONSTINIT const QMetaObject FenetreConnexion::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ZN16FenetreConnexionE.offsetsAndSizes,
    qt_meta_data_ZN16FenetreConnexionE,
    qt_static_metacall,
    nullptr,
...
void *FenetreConnexion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16FenetreConnexionE.stringdata0))
